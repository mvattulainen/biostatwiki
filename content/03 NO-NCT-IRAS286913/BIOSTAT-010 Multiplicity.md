...
Multiple primary and secondary outcome measures are listed, but no multiplicity strategy is visible in the indexed excerpt.

## Statistical Claim-to-Evidence

### Claim BIOSTAT-010-1: Vision and balance changes after bilateral implantation of Toric IOLs is missing for multiplicity because multiplicity control is incomplete or should be checked against endpoint hierarchy
...
**SAP evidence:** Prot_SAP_000c.pdf, lines 208-226. Semantic confidence: Medium.
