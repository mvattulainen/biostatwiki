...
Multiple secondary outcomes are listed, but no endpoint hierarchy or multiplicity adjustment is specified.

## Statistical Claim-to-Evidence

### Claim BIOSTAT-010-1: PuraBond PROOF Study is missing for multiplicity because multiplicity control is incomplete or should be checked against endpoint hierarchy

**Trusted source evidence:** MultipleEndpoints_FinalGuidance.pdf, lines 262-310. Confidence score: 80/100 (BM25/get fallback; rerank unavailable in this runtime).
...
**SAP evidence:** Prot_SAP_000_b.pdf, lines 673-686 and 728-738. Confidence score: 80/100 (indexed SAP text fallback; rerank unavailable in this runtime).

> Multiple secondary outcomes are listed, but no endpoint hierarchy or multiplicity adjustment is specified.

**Status:** Missing

**Gap:** Multiplicity control is incomplete or should be checked against endpoint hierarchy.
